package omni.android.chipdna

import android.content.Context
import com.creditcall.chipdnamobile.*
import omni.common.data.*
import omni.common.data.models.Merchant
...
class ChipDnaDriver : CoroutineScope, MobileReaderDriver {
    ...
    companion object {
         ...
         */
        private fun extractUserReference(transaction: Transaction): String? = transaction.getMetaString("nmiUserRef")
