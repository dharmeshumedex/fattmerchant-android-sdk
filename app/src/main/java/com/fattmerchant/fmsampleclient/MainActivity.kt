...
import omni.android.InitParams
import omni.android.Omni
...
import omni.common.data.Amount
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initializeOmni(apiKey: String) {
        Omni.initialize(
                InitParams(applicationContext, apiKey, OmniApi.Environment.DEV, "myapp"), {
            runOnUiThread {
